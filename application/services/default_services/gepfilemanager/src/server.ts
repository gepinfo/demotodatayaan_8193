...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_demotodatayaan_8193;
            let db_auth = result.data.DB_AUTH_demotodatayaan_8193;
            let db_coll = result.data.DB_COLL_demotodatayaan_8193;
